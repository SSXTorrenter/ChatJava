...
public class FrmMain extends javax.swing.JFrame {
    ...
    public static String ADDRESS;//NOSONAR
    public static int PORT;//NOSONAR
    public static boolean CONNECTION_ESTABLISHED = false;//NOSONAR
    
    private final static Logger LOG = Logger.getLogger(FrmMain.class.getName());
    /**
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        if (!userOwnerExist() && CONNECTION_ESTABLISHED) {
    ...
    private void btnSuprimerAmiActionPerformed(java.awt.event.ActionEvent evt) {try {
//GEN-FIRST:event_BtnSuprimerAmiActionPerformed
        lstF.setPos(lstAmis.getSelectedIndex());
